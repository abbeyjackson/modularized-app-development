//
//  AuthenticationResponseData.swift
//  Networking
//
...
public struct AuthenticationResponseData : ResponseData {
    public let dataDictionary: [String : AnyObject]
    
    internal init(userID: String, token: String) {
        self.dataDictionary = [AuthenticationConstants.userId.rawValue: userID,
                     AuthenticationConstants.token.rawValue: token] as [String : AnyObject]
    }
}
